...
namespace Here_Web_All.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUser_UserType = table.Column<byte>(nullable: false, defaultValue: (byte)3),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Bolumler_BolumId",
                        column: x => x.BolumId,
                        principalTable: "Bolumler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Fakulteler_FakulteId",
                        column: x => x.FakulteId,
                        principalTable: "Fakulteler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Universiteler_UniversiteId",
                        column: x => x.UniversiteId,
                        principalTable: "Universiteler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DersAdi = table.Column<string>(maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OgrenciDetaylari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OgrenciDetaylari_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OgretmenDetaylari", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OgretmenDetaylari_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlinanDersler", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlinanDersler_Dersler_DersId",
                        column: x => x.DersId,
                        principalTable: "Dersler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlinanDersler_AspNetUsers_OgrenciId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlinanDersler_DersId",
                table: "AlinanDersler",
                column: "DersId");

            migrationBuilder.CreateIndex(
                name: "IX_AlinanDersler_OgrenciId",
                table: "AlinanDersler",
                column: "OgrenciId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OgrenciDetaylari_UserId",
                table: "OgrenciDetaylari",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OgretmenDetaylari_UserId",
                table: "OgretmenDetaylari",
                column: "UserId",
                unique: true);
